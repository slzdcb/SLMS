...
public class SendEmailUtil {
    ...
    public static boolean sendMail(String emailAddress, String emailMsg) {
        ...
        // 发送者的用户名和密码(邮箱登录用)
        final String username = "1140655668"; // 此处填写发送的邮箱名
        final String password = "sgoxekieqqbcbadd"; // 此处填写登录的邮箱密码（授权码！非密码）
        ...
        try {
            ...
            // 设置邮件发送的主题<邮件标题>
            message.setSubject("学生服务管理系统 验证码");
